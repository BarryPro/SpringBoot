...
import com.belong.model.UserExample.Criteria;
import com.belong.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getPagenum() != null) {
            VALUES("pagenum", "#{pagenum,jdbcType=INTEGER}");
        }
        
        if (record.getPic() != null) {
            VALUES("pic", "#{pic,jdbcType=LONGVARBINARY}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPagenum() != null) {
            SET("pagenum = #{record.pagenum,jdbcType=INTEGER}");
        }
        
        if (record.getPic() != null) {
            SET("pic = #{record.pic,jdbcType=LONGVARBINARY}");
        }
